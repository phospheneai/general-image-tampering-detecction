...
Unlike traditional copy-move and splicing datasets, CocoGlide represents a newer class of image manipulation in which generative models are used to modify image content.
...
Many image-forensics papers create their own experimental partitions from the original dataset. Therefore:
...
For reproducibility, users should record the exact split protocol used in their experiments.
